...
interface UserContextType {
  ...
  setRegistrationData: React.Dispatch<
    React.SetStateAction<RegistrationProcessState>
  >;
  continueRegistrationData: ContinueRegistrationState;
  setContinueRegistrationData: React.Dispatch<
    React.SetStateAction<ContinueRegistrationState>
  >;
  continueRegistrationActiveStep: number;
  setContinueRegistrationActiveStep: React.Dispatch<
...
export function UserProvider({ children }: UserProviderProps) {
  ...
  const [continueRegistrationData, setContinueRegistrationData] =
  ...
  const [continueRegistrationActiveStep, setContinueRegistrationActiveStep] =
    useState(0);
