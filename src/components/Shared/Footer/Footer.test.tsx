...
describe("Footer Component Tests", () => {
  ...
  it("must contain correct links", () => {
    ...
    expect(links[0]).toHaveAttribute(
      "href",
      "https://www.facebook.com/OfficialNIHR/",
    );
    expect(links[1]).toHaveAttribute(
      "href",
      "https://twitter.com/NIHRtakepart",
    );
    expect(links[2]).toHaveAttribute(
      "href",
      "https://www.youtube.com/user/NIHRtv",
    );
    expect(links[3]).toHaveAttribute(
      "href",
      "https://www.linkedin.com/company/nihr-research",
    );
    ...
    expect(links[7]).toHaveAttribute(
      "href",
      "https://bepartofresearch.nihr.ac.uk/about/glossary/",
    );
    expect(links[7]).toHaveTextContent("Glossary");
    expect(links[8]).toHaveAttribute(
      "href",
      "https://bepartofresearch.nihr.ac.uk/about/frequently-asked-questions/",
    );
    ...
    expect(links[9]).toHaveTextContent("What is research?");
    expect(links[10]).toHaveAttribute(
      "href",
      "https://bepartofresearch.nihr.ac.uk/taking-part/why-take-part/",
    );
    ...
    expect(links[11]).toHaveTextContent("What happens next?");
    expect(links[12]).toHaveAttribute(
      "href",
      "https://bepartofresearch.nihr.ac.uk/taking-part/Consent/",
    );
    expect(links[12]).toHaveTextContent("Consenting to a study");

    expect(links[13]).toHaveAttribute(
      "href",
      "https://bepartofresearch.nihr.ac.uk/site-policies/accessibility",
    );
    expect(links[13]).toHaveTextContent("Accessibility");
    expect(links[14]).toHaveAttribute(
      "href",
      "https://bepartofresearch.nihr.ac.uk/site-policies/complaints",
    );
    expect(links[14]).toHaveTextContent("Complaints");
    expect(links[15]).toHaveAttribute(
      "href",
      "https://bepartofresearch.nihr.ac.uk/site-policies/cookie-policy",
    );
    ...
    expect(links[18]).toHaveAttribute(
      "href",
      "https://bepartofresearch.nihr.ac.uk/site-policies/terms-and-conditions",
    );
    expect(links[18]).toHaveTextContent("Terms and conditions");

    expect(links[19]).toHaveAttribute(
      "href",
      "https://bepartofresearch.nihr.ac.uk/Articles/index",
    );
    expect(links[19]).toHaveTextContent("Blogs");
    expect(links[20]).toHaveAttribute(
      "href",
      "https://bepartofresearch.nihr.ac.uk/about/#contact-form",
    );
    ...
    expect(links[24]).toHaveAttribute(
      "href",
      "https://www.research.hscni.net/",
    );
    expect(links[25]).toHaveAttribute(
      "href",
      "https://www.nhsresearchscotland.org.uk/",
    );
    expect(links[26]).toHaveAttribute(
      "href",
