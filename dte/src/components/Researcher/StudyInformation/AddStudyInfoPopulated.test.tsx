          ...
          return {
            content: {
              ...
              item: {
                ...
                shortName: null,
                whatImportant: "This is what is important",
                healthConditions: ["Head and neck cancer", "Potassium test"],
...
describe("AddStudyInfo tests", () => {
  ...
  it("pre-populates the form fields", async () => {
    render(<AddStudyInfo />);
    expect(
      await screen.findByText("This is what is important")
    ).toBeInTheDocument();
    expect(await screen.findByText("Head and neck cancer")).toBeInTheDocument();
  });
  it("should save the study information", async () => {
    render(<AddStudyInfo />);
